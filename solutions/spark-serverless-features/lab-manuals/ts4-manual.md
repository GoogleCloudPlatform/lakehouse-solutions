...
|#| Content | 
| -- | :--- | 
|1| [[INFORMATIONAL] Lakehouse reference architecture](./ts4-manual.md#181-lakehouse-reference-architecture) | 
|2| [[ABOUT THE LAB] Lab solution architecture](./ts4-manual.md#182-lab-solution-architecture) | 
...
This hands-on lab complements the blog post [Lakehouse Demystified - Part 4: Managed Service for Apache Airflow](TODO) - reading the blog is recommended for full understanding of the product. The product documentation can be found [here](https://docs.cloud.google.com/composer/docs/composer-3/composer-overview)).
